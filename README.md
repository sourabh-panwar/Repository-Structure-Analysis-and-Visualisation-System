...
* **Integrated AI Auditor:** A split-screen, resizable dark-mode IDE panel that allows developers to view raw code and trigger one-click AI prompts (Find Bugs, Refactor, ELI5) using the Gemini API.
